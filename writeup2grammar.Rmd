...
date: "May 6, 2018"
abstract: |
  Cryptocurrencies such as Bitcoin, Ethereum, etc. generated significant attention in 2017 due to dramatic price increases followed by a spectacular drop in 2018. Cryptocurrencies have significant volatility as there is rampant speculation combined with a lack of tangible resources to provide a proxy for real-world value. Given the high variance in prices, can data science methods explored in this class be used to model the market dynamics?
output: 
  pdf_document:
    toc: true
    toc_depth: 3
...
to analyze market dynamics. We also obtained historical pricing of eighteen traditional securities
...
=======
We attempted several different distributions to find the best fit: beta, cauchy, inverse gamma.
>>>>>>> b856832de200f01f4b60e26d62c6be58d88af680

We used the R MASS package, with the `fitdistr` to find the optimal parameters.
