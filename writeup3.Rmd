...
#a is intercept
a <- mean(XMRdf$Close) - b*mean(BTCdf$Close)
...
cntgTableCustom <- function(firstIndex, periods, periodlength, vixrange) {
  ...
  mosaicplot( table, col = c("firebrick", "goldenrod1"), cex.axis = 1, sub = "VIX Change", ylab = "Variance Increased", main = "")
  table
}
...
cntgTableCustom(firstIndex, 6, 30, 3)
